...
class SendMailClass {
    ...
    public function __construct() {
        ...
        $this->mail->Username = get_option('company_email');
        $this->mail->Password = get_option('company_email_password');
// mail nguoi goi
        $this->mail->setFrom('mailsendtocustom@gmail.com', 'BEAUTIFUL LUGGAGE 美麗華皮件箱包-訂單');
// mail reply
        $this->mail->addReplyTo(get_option('company_contact_email'), '回復');
// tieu de mail 
        $this->mail->Subject = 'BEAUTIFUL LUGGAGE 美麗華皮件箱包-訂單';
//thiet lap charset
