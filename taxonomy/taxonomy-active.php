...
class Taxonomy_Active {
    ...
    public function __construct() {
        ...
        add_action('active_category_edit_form_fields', array($this, 'edit_form'));

        add_filter("manage_edit-active_category_columns", array($this, 'category_columns'), 10, 3);
        add_filter("manage_active_category_custom_column", array($this, 'category_columns_manage'), 10, 3);

        add_action('create_active_category', array($this, 'save_option'));
        add_action('edited_active_category', array($this, 'save_option'));
