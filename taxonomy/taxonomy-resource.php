...
class Taxonomy_Resources
{

    private $prefix_name = 'option_resources_category_';

    public function __construct()
    {
        add_action('init', array($this, 'create_taxonomy'));

        add_action('resources_category_add_form_fields', array($this, 'add_form'));
        add_action('resources_category_edit_form_fields', array($this, 'edit_form'));
        ...
        add_action('delete_resources_category', array($this, 'delete_option'));
    }
    ...
    public function create_taxonomy()
    {
        ...
        register_taxonomy('resources_category', 'resources', array(
            'hierarchical' => true,
            'labels' => $labels,
            'show_ui' => true,
            'query_var' => true,
