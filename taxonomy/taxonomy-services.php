...
class Taxonomy_Services
{

    private $prefix_name = 'option_services_category_';

    public function __construct()
    {
        add_action('init', array($this, 'create_taxonomy'));

        add_action('services_category_add_form_fields', array($this, 'add_form'));
        add_action('services_category_edit_form_fields', array($this, 'edit_form'));

        add_filter("manage_edit-services_category_columns", array($this, 'category_columns'), 10, 3);
        add_filter("manage_services_category_custom_column", array($this, 'category_columns_manage'), 10, 3);
