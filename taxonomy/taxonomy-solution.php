...
class Taxonomy_Solution
{
    ...
    public function __construct()
    {
        ...
        add_action('solutions_category_edit_form_fields', array($this, 'edit_form'));

        add_filter("manage_edit-solutions_category_columns", array($this, 'category_columns'), 10, 3);
        add_filter("manage_solutions_category_custom_column", array($this, 'category_columns_manage'), 10, 3);
    ...
    public function create_taxonomy()
    {
        ...
        register_taxonomy('solutions_category', 'solutions', array(
            'hierarchical' => true,
            'labels' => $labels,
            'show_ui' => true,
            'query_var' => true,
