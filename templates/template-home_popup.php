    ...
    <div class="dgw-popup">
        <div class="dgw-popup-space">
            ...
            <div class="popup-link item"
                ...
                <img class="img-computer" src=" <?php echo PART_IMAGES . 'pop-up/' . $data['img_' . $lang ]?>"></img>
                <img class="img-mobile" src=" <?php echo PART_IMAGES . 'pop-up/' . $data['img_mobile_' .$lang] ?>"></img>
            </div>
        </div>
    </div>
    <script>
