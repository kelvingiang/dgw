<div class="view_like_area">
    <div class="view_like_content">
        <div>
            ...
            <div>
                <svg class="icon-comment" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
        ...
        <div>
            ...
            <div class="like-click">
                <svg class="icon-comment" data-post="<?php echo $post->ID ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
