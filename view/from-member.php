    ...
    <div style="width: 98%">
        ...
        <div class="row-two-column">
            <div class="col">
                ...
                <div class="cell-text">
                    <input type="text" id="txt_soft" 
                           name="txt_soft"
                           class="my-input" 
                           value="<?php echo $item['use_soft'] ?>" />
                </div>
            </div>
        </div>
        ...
        <div class="row-two-column">
            <div class="col">
                ...
                <div class="cell-text">
                    <input type="text" id="txt_career" 
                           name="txt_career"
                           class="my-input" 
                           value="<?php echo $item['career'] ?>" />
                </div>
            </div>
        </div>
        ...
        <div class="row-two-column">
            <div class="col">
                ...
                <div class="cell-text">
                    <input type="text" id="txt_order" name="txt_order" class="my-input type-number" 
                           placeholder = "<?php _e('The larger the number will show in front') ?>"
                           value="<?php echo $item['is_order'] ?>" />
                </div>
            </div>
        </div>
        <hr>
